      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          {SESSION_EXPORT_FORMATS.map((format) => (
            <label
              key={format.value}
              className="flex cursor-pointer gap-3 rounded-lg p-3 hover:bg-slate-50 dark:hover:bg-gray-700/50"
            >
              <input
                type="radio"
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:items-center justify-between border-t border-slate-100 dark:border-gray-700/50 pt-4 mt-6">
          <div className="flex items-center gap-2 text-sm text-slate-700 dark:text-gray-300">
            ...
            <span className="relative inline-flex h-6 w-6 items-center justify-center group">
              ...
              <span
                role="tooltip"
                className="pointer-events-none absolute -top-2 left-0 z-10 w-72 -translate-y-full rounded-md border border-slate-200 bg-white px-3 py-2 text-xs leading-snug text-slate-700 opacity-0 shadow-md transition-none group-hover:opacity-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200"
              >
