...
export default function AchievementsModal({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      <Card className="w-full max-w-lg bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 shadow-sm max-h-[85vh] flex flex-col">
        <div className="border-b border-slate-200 dark:border-gray-700 p-6">
          <h2 className="text-lg font-bold text-slate-900 dark:text-gray-100 tracking-tight">Achievements</h2>
