-- Migration to automatically convert streak count when changing streak cadence.
-- E.g. a 2 bi-weekly streak converted to weekly is a 4 week streak. Round down.
